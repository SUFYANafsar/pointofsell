        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="text-right">@lang('Whole Sell Price')</th>
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td class="text-right"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->product->product_custom_field1 }}</span></td>
